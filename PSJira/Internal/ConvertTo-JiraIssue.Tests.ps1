        ...
        $sampleJson = @'
{
  ...
  "id": "320391",
  "self": "https://jira.atlassian.com/rest/api/latest/issue/320391",
  "key": "JRA-37294",
  "fields": {
    ...
    "components": [
      {
        "self": "https://jira.atlassian.com/rest/api/2/component/13170",
        "id": "13170",
    ...
    "creator": {
      "self": "https://jira.atlassian.com/rest/api/2/user?username=takindele",
      "name": "takindele",
      "key": "takindele",
    ...
    "votes": {
      "self": "https://jira.atlassian.com/rest/api/2/issue/JRA-37294/votes",
      "votes": 50,
      "hasVoted": false
    },
    "worklog": {
    ...
    "workratio": -1,
    "watches": {
      "self": "https://jira.atlassian.com/rest/api/2/issue/JRA-37294/watchers",
      "watchCount": 32,
      "isWatching": false
    },
    ...
    "comment": {
      ...
      "comments": [
        {
          "self": "https://jira.atlassian.com/rest/api/2/issue/320391/comment/573751",
          "id": "573751",
          "author": {
            "self": "https://jira.atlassian.com/rest/api/2/user?username=fanno",
            "name": "fanno",
            "key": "fanno",
            "emailAddress": "fannoj at gmail dot com",
            "avatarUrls": {
              "48x48": "https://jira.atlassian.com/secure/useravatar?ownerId=fanno&avatarId=78570",
              "24x24": "https://jira.atlassian.com/secure/useravatar?size=small&ownerId=fanno&avatarId=78570",
              "16x16": "https://jira.atlassian.com/secure/useravatar?size=xsmall&ownerId=fanno&avatarId=78570",
              "32x32": "https://jira.atlassian.com/secure/useravatar?size=medium&ownerId=fanno&avatarId=78570"
            },
        ...
        {
          "self": "https://jira.atlassian.com/rest/api/2/issue/320391/comment/589184",
          "id": "589184",
          "author": {
            "self": "https://jira.atlassian.com/rest/api/2/user?username=intersol_OLD",
            "name": "intersol_OLD",
            "key": "intersol_old",
        ...
        {
          "self": "https://jira.atlassian.com/rest/api/2/issue/320391/comment/623287",
          "id": "623287",
          "author": {
            "self": "https://jira.atlassian.com/rest/api/2/user?username=matt.doar",
            "name": "matt.doar",
            "key": "matt.doar",
            "emailAddress": "matt dot doar at servicerocket dot com",
            "avatarUrls": {
              "48x48": "https://jira.atlassian.com/secure/useravatar?ownerId=matt.doar&avatarId=66289",
              "24x24": "https://jira.atlassian.com/secure/useravatar?size=small&ownerId=matt.doar&avatarId=66289",
              "16x16": "https://jira.atlassian.com/secure/useravatar?size=xsmall&ownerId=matt.doar&avatarId=66289",
              "32x32": "https://jira.atlassian.com/secure/useravatar?size=medium&ownerId=matt.doar&avatarId=66289"
            },
        ...
        {
          "self": "https://jira.atlassian.com/rest/api/2/issue/320391/comment/623380",
          "id": "623380",
          "author": {
            "self": "https://jira.atlassian.com/rest/api/2/user?username=fanno",
            "name": "fanno",
        ...
        {
          "self": "https://jira.atlassian.com/rest/api/2/issue/320391/comment/623669",
          "id": "623669",
          "author": {
            "self": "https://jira.atlassian.com/rest/api/2/user?username=matt.doar",
            "name": "matt.doar",
        ...
        {
          "self": "https://jira.atlassian.com/rest/api/2/issue/320391/comment/634580",
          "id": "634580",
          "author": {
            "self": "https://jira.atlassian.com/rest/api/2/user?username=jhu",
            "name": "jhu",
            "key": "jhu",
        ...
        {
          "self": "https://jira.atlassian.com/rest/api/2/issue/320391/comment/684791",
          "id": "684791",
          "author": {
            "self": "https://jira.atlassian.com/rest/api/2/user?username=matt.doar",
            "name": "matt.doar",
        ...
        {
          "self": "https://jira.atlassian.com/rest/api/2/issue/320391/comment/706972",
          "id": "706972",
          "author": {
            "self": "https://jira.atlassian.com/rest/api/2/user?username=markdw",
            "name": "markdw",
            "key": "markdw",
            "emailAddress": "mdwilliams1 at dstsystems dot com",
            "avatarUrls": {
              "48x48": "https://jira.atlassian.com/secure/useravatar?ownerId=markdw&avatarId=66693",
              "24x24": "https://jira.atlassian.com/secure/useravatar?size=small&ownerId=markdw&avatarId=66693",
              "16x16": "https://jira.atlassian.com/secure/useravatar?size=xsmall&ownerId=markdw&avatarId=66693",
              "32x32": "https://jira.atlassian.com/secure/useravatar?size=medium&ownerId=markdw&avatarId=66693"
            },
            "displayName": "MarkW",
            "active": true,
        ...
        {
          "self": "https://jira.atlassian.com/rest/api/2/issue/320391/comment/712103",
          "id": "712103",
          "author": {
            "self": "https://jira.atlassian.com/rest/api/2/user?username=sean26",
            "name": "sean26",
            "key": "sean26",
            "emailAddress": "sean at squareup dot com",
            "avatarUrls": {
              "48x48": "https://jira.atlassian.com/secure/useravatar?ownerId=sean26&avatarId=74797",
              "24x24": "https://jira.atlassian.com/secure/useravatar?size=small&ownerId=sean26&avatarId=74797",
              "16x16": "https://jira.atlassian.com/secure/useravatar?size=xsmall&ownerId=sean26&avatarId=74797",
              "32x32": "https://jira.atlassian.com/secure/useravatar?size=medium&ownerId=sean26&avatarId=74797"
            },
        ...
        {
          "self": "https://jira.atlassian.com/rest/api/2/issue/320391/comment/732650",
          "id": "732650",
          "author": {
            "self": "https://jira.atlassian.com/rest/api/2/user?username=torben.hoeft",
            "name": "torben.hoeft",
            "key": "torben.hoeft",
        ...
        {
          "self": "https://jira.atlassian.com/rest/api/2/issue/320391/comment/746403",
          "id": "746403",
          "author": {
            "self": "https://jira.atlassian.com/rest/api/2/user?username=congnv",
            "name": "congnv",
            "key": "congnv",
        ...
        {
          "self": "https://jira.atlassian.com/rest/api/2/issue/320391/comment/746450",
          "id": "746450",
          "author": {
            "self": "https://jira.atlassian.com/rest/api/2/user?username=torben.hoeft",
            "name": "torben.hoeft",
        ...
        {
          "self": "https://jira.atlassian.com/rest/api/2/issue/320391/comment/823128",
          "id": "823128",
          "author": {
            "self": "https://jira.atlassian.com/rest/api/2/user?username=stanislaw",
            "name": "stanislaw",
            "key": "stanislaw",
        ...
        {
          "self": "https://jira.atlassian.com/rest/api/2/issue/320391/comment/823304",
          "id": "823304",
          "author": {
            "self": "https://jira.atlassian.com/rest/api/2/user?username=fanno",
            "name": "fanno",
        ...
        {
          "self": "https://jira.atlassian.com/rest/api/2/issue/320391/comment/823427",
          "id": "823427",
          "author": {
            "self": "https://jira.atlassian.com/rest/api/2/user?username=torben.hoeft",
            "name": "torben.hoeft",
        ...
        {
          "self": "https://jira.atlassian.com/rest/api/2/issue/320391/comment/833460",
          "id": "833460",
          "author": {
            "self": "https://jira.atlassian.com/rest/api/2/user?username=fanno",
            "name": "fanno",
...
'@
        ...
        Context "Basic behavior testing" {
            ...
            It "Sets the type name to PSJira.Issue" {
                $r | Test-HasTypeName 'PSJira.Issue' | Should Be $True
            }

            defProp $r 'Key' 'JRA-37294'
            defProp $r 'Id' '320391'
            defProp $r 'RestUrl' 'https://jira.atlassian.com/rest/api/latest/issue/320391'
            defProp $r 'HttpUrl' "https://jira.atlassian.com/browse/JRA-37294"
...
#            Mock ConvertTo-JiraUser -ModuleName PSJira { $InputObject }
            ...
            It "Defines Date fields as Date objects" {
                ...
                foreach ($f in $dateFields)
                {
                    ...
                    $value | Test-HasTypeName 'System.DateTime' | Should Be $True
                }
            }
            ...
            It "Uses ConvertTo-JiraUser to return user fields as User objects" {
                ...
                foreach ($f in $userFields)
                {
                    $value = $r.$f
                    $value | Should Not BeNullOrEmpty
                    $value | Test-HasTypeName 'PSJira.User' | Should Be $True
                }
            ...
            It "Uses ConvertTo-JiraProject to return the project as an object" {
                $r.Project  | Test-HasTypeName 'PSJira.Project' | Should Be $True
            }

            It "Uses ConvertTo-JiraTransition to return the issue's transitions as an object array" {
                @(,$r.Transition) | Test-HasTypeName 'System.Object[]' | Should Be $True
                $r.Transition[0] | Test-HasTypeName 'PSJira.Transition' | Should Be $True
            }
        }
    }
}

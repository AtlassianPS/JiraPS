...
"@
        ...
        Context "Behavior testing" {
            ...
            It "resolves errors" {
                ...
                Should -Invoke -CommandName Resolve-ErrorWebResponse -ModuleName $env:BHProjectName -Exactly -Times 1 -Scope It
            }

            It "supports TLS1.2 connections" {
                Invoke-JiraMethod -URI "https://postman-echo.com/get?test=123" -ErrorAction Stop

                Should -Invoke -CommandName Set-TlsLevel -ModuleName $env:BHProjectName -Exactly -Times 2 -Scope It
                Should -Invoke -CommandName Set-TlsLevel -ModuleName $env:BHProjectName -ParameterFilter {$Tls12 -eq $true} -Exactly -Times 1 -Scope It
                Should -Invoke -CommandName Set-TlsLevel -ModuleName $env:BHProjectName -ParameterFilter {$Revert -eq $true} -Exactly -Times 1 -Scope It
            }

            It "uses global default values for parameters" {
                Invoke-JiraMethod -URI "https://postman-echo.com/get?test=123" -ErrorAction Stop

                Should -Invoke -CommandName Resolve-DefaultParameterValue -ModuleName $env:BHProjectName -Exactly -Times 1 -Scope It
            }
        }
        ...
        Context "Input testing" {
            ...
            It "Accepts [<_>] as HTTP method" -ForEach @('GET', 'POST', 'PUT', 'DELETE') {
                Invoke-JiraMethod -Method $_ -URI "https://postman-echo.com/$_"
            ...
            It "uses ConvertTo-JiraSession to store the Session" {
                ...
                Should -Invoke @assertMockCalledSplat
                Should -Invoke -CommandName ConvertTo-JiraSession -ModuleName $env:BHProjectName -Exactly -Times 1 -Scope It
            }
            ...
            It "uses session if no -Credential are passed" {
                ...
                Should -Invoke @assertMockCalledSplat
                Should -Invoke -CommandName Get-JiraSession -ModuleName $env:BHProjectName -Exactly -Times 1 -Scope It
            }
            ...
            It "uses -Credential even if session is present" {
                ...
                Should -Invoke @assertMockCalledSplat
                Should -Invoke -CommandName Get-JiraSession -ModuleName $env:BHProjectName -Exactly -Times 0 -Scope It
            }

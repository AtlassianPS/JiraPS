...
### Template A: CRUD Functions (Get/Set/Remove/New/Add)

**Reference File**: `Tests/Functions/Add-JiraFilterPermission.Unit.Tests.ps1`
...
### Template B: Converter Functions (ConvertTo-*/ConvertFrom-*)

**Reference File**: `Tests/Functions/ConvertTo-JiraAttachment.Unit.Tests.ps1`
...
| Aspect         | Template A (CRUD)                     | Template B (Converters)                                                |
| -------------- | ------------------------------------- | ---------------------------------------------------------------------- |
...
## Test Helpers (TestTools.psm1)

The `Tests/Helpers/TestTools.psm1` module provides reusable functions for test setup:

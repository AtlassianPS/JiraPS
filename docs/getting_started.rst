...
.. note:: If you installed PSJira to Program Files, you may need to run the above command in an elevated PowerShell session. Otherwise, you might get an Access Denied error.
